...
export default function Home() {
	return (
		<main className='min-h-screen px-6 py-20 flex flex-col lg:flex-row gap-16 lg:items-center lg:px-40 lg:justify-between'>
			<div className='text-center space-y-4 text-white lg:max-w-lg lg:text-start'>
